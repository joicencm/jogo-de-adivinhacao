    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                int totalDeTentativas = ObterNumeroDeTentativas();
                ...
                {
                    bool acertou = JogarTentativa(tentativa, totalDeTentativas, numerosDigitados, numeroSecreto, ref pontos);
        ...
        static int ObterNumeroDeTentativas()
        {
        ...
        static bool JogarTentativa(int tentativa, int totalDeTentativas, string[] numerosDigitados, int numeroSecreto, ref int pontos)
        {
            Console.Clear();
            Console.WriteLine("---------------------------------------------------------------------------------------------");
        ...
        static bool Ganhador(int pontos)
        {
